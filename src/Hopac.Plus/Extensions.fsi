...
module OptionJob =
  ...
  val traverse : xJ2yJ:(Job<'x> -> #Job<'y>) -> xJO:Job<'x> option -> Job<'y option>
  val sequence :                                xJO:Job<'x> option -> Job<'x option>
...
module ChoiceJob =
  ...
  val foldJob : x2tJ:('x -> #Job<'t>) -> y2t:('y -> #Job<'t>) -> xyCJ:Job<Choice<'x,'y>> -> Job<'t>

  val traverse :     xJ2aJ:(Job<'x> -> #Job<'a>)                                -> xJyC:(Choice<Job<'x>,   'y >) -> Job<Choice<'a,'y>>
  val sequence :                                                                   xJyC:(Choice<Job<'x>,   'y >) -> Job<Choice<'x,'y>>

  val traverseLeft :                                yJ2bJ:(Job<'y> -> #Job<'b>) -> xyJC:(Choice<    'x ,Job<'y>>) -> Job<Choice<'x,'b>>
  val sequenceLeft :                                                               xyJC:(Choice<    'x ,Job<'y>>) -> Job<Choice<'x,'y>>

  val traverseBoth : xJ2aJ:(Job<'x> -> #Job<'a>) -> yJ2bJ:(Job<'y> -> #Job<'b>) -> xyJC:(Choice<Job<'x>,Job<'y>>) -> Job<Choice<'a,'b>>
  val sequenceBoth :                                                               xyJC:(Choice<Job<'x>,Job<'y>>) -> Job<Choice<'x,'y>>
